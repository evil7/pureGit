/**
 * GitHub REST API 数据层 barrel（收拢于 lib/restapi/ 子目录）
 *
 * 按业务板块拆分（原 github-*.ts 改名 rest-*.ts，2026-08-13 收拢到本子目录）：
 ...
 * 本文件仅 re-export；对外经 lib/rest.ts（薄兼容 barrel）与 lib/api.ts 透传。
 */
...
export * from "./rest-insights";
export * from "./rest-webhooks";
export * from "./rest-pages";
export * from "./rest-branch-protection";
export * from "./rest-security";
export * from "./rest-tags";
export * from "./rest-issue-subtask";
export * from "./rest-code-security";
