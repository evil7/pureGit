 ...
 * topics / 订阅 / 分支（简列表/最近/分页详情） / 删除 / Security 安全公告。
 */
...
/** 智能获取仓库分支（简列表：名称 + 最新 sha）：GraphQL repository.refs 首选，失败降级 REST。
 * 供 useBranchPath / RepoCode 分支选择器等轻量场景用（完整提交信息 + ahead/behind 走 fetchBranchesDetailSmart）。 */
