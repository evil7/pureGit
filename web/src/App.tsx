...
const GistDetailPage = lazy(() =>
  import("@/pages/gist/GistPage").then((m) => ({ default: m.GistDetailPage })),
);
const GistEditPage = lazy(() =>
  import("@/pages/gist/GistPage").then((m) => ({ default: m.GistEditPage })),
);
const NewGistPage = lazy(() =>
  import("@/pages/gist/GistPage").then((m) => ({ default: m.NewGistPage })),
);
const RepoLayout = lazy(() => import("@/components/RepoLayout"));
const RepoCode = lazy(() => import("@/pages/repo/RepoCode"));
const CodeIndex = lazy(() => import("@/pages/repo/CodeIndex"));
const TreePage = lazy(() => import("@/pages/repo/TreePage"));
const BlobPage = lazy(() => import("@/pages/repo/BlobPage"));
const BranchesPage = lazy(() => import("@/pages/repo/BranchesPage"));
const LabelsPage = lazy(() => import("@/pages/issues/LabelsPage"));
const MilestonesPage = lazy(() => import("@/pages/issues/MilestonesPage"));
const StargazersPage = lazy(() => import("@/pages/repo/StargazersPage"));
const WatchersPage = lazy(() =>
  import("@/pages/repo/StargazersPage").then((m) => ({ default: m.WatchersPage })),
);
const CommitPage = lazy(() => import("@/pages/repo/CommitPage"));
const CommitsPage = lazy(() => import("@/pages/repo/CommitsPage"));
const UploadPage = lazy(() => import("@/pages/repo/UploadPage"));
const ForkPage = lazy(() => import("@/pages/repo/ForkPage"));
const ForksPage = lazy(() => import("@/pages/repo/ForksPage"));
...
const PullsPage = lazy(() => import("@/pages/issues/PullsPage"));
const PullDetailPage = lazy(() => import("@/pages/issues/PullDetailPage"));
const NewIssuePage = lazy(() => import("@/pages/issues/NewIssuePage"));
const NewPullRequestPage = lazy(() => import("@/pages/issues/NewPullRequestPage"));
const NewRepositoryPage = lazy(() => import("@/pages/repo-new/NewRepositoryPage"));
const ReleasesPage = lazy(() => import("@/pages/releases/ReleasesPage"));
const TagsPage = lazy(() => import("@/pages/releases/TagsPage"));
const ReleaseDetailPage = lazy(() => import("@/pages/releases/ReleaseDetailPage"));
const ReleaseEditPage = lazy(() => import("@/pages/releases/ReleaseEditPage"));
...
const DependabotAlertsPage = lazy(() =>
  import("@/pages/security/SecurityAlertsPage").then((m) => ({ default: m.DependabotAlertsPage })),
);
const CodeScanningAlertsPage = lazy(() =>
  import("@/pages/security/SecurityAlertsPage").then((m) => ({
    default: m.CodeScanningAlertsPage,
  })),
);
const SecretScanningAlertsPage = lazy(() =>
  import("@/pages/security/SecurityAlertsPage").then((m) => ({
    default: m.SecretScanningAlertsPage,
  })),
);
const InsightsPage = lazy(() => import("@/pages/insights/InsightsPage"));
const TrafficPage = lazy(() => import("@/pages/insights/TrafficPage"));
const ContributorsPage = lazy(() => import("@/pages/insights/ContributorsPage"));
const CommunityPage = lazy(() => import("@/pages/insights/CommunityPage"));
const CodeFrequencyPage = lazy(() => import("@/pages/insights/CodeFrequencyPage"));
const CommitActivityPage = lazy(() => import("@/pages/insights/CommitActivityPage"));
...
const ActionsUsagePage = lazy(() => import("@/pages/actions/ActionsUsagePage"));
...
const DiscussionDetailPage = lazy(() =>
  import("@/pages/discussions/DiscussionDetail").then((m) => ({
    default: m.DiscussionDetailPage,
  })),
);
const NewDiscussionChoosePage = lazy(() =>
  import("@/pages/discussions/NewDiscussion").then((m) => ({
    default: m.NewDiscussionChoosePage,
  })),
);
const NewDiscussionPage = lazy(() =>
  import("@/pages/discussions/NewDiscussion").then((m) => ({ default: m.NewDiscussionPage })),
);
...
const RepoSettingsLayout = lazy(() => import("@/pages/settings/RepoSettingsLayout"));
const RepoSettingsPage = lazy(() => import("@/pages/settings/RepoSettingsPage"));
const RepoCollaboratorsSettings = lazy(() => import("@/pages/settings/RepoCollaboratorsSettings"));
const RepoSecuritySettings = lazy(() => import("@/pages/settings/RepoSecuritySettings"));
const RepoModerationSettings = lazy(() => import("@/pages/settings/RepoModerationSettings"));
const RepoDeployKeysSettings = lazy(() => import("@/pages/settings/RepoDeployKeysSettings"));
const RepoEnvironmentsSettings = lazy(() => import("@/pages/settings/RepoEnvironmentsSettings"));
const RepoGitHubAppsSettings = lazy(() => import("@/pages/settings/RepoGitHubAppsSettings"));
const RepoSecretsSettings = lazy(() => import("@/pages/settings/RepoSecretsSettings"));
const RepoWebhooksSettings = lazy(() => import("@/pages/settings/RepoWebhooksSettings"));
const RepoPagesSettings = lazy(() => import("@/pages/settings/RepoPagesSettings"));
const RepoBranchesSettings = lazy(() => import("@/pages/settings/RepoBranchesSettings"));
const RepoCopilotSettings = lazy(() => import("@/pages/settings/RepoCopilotSettings"));
const RepoCodespacesSettings = lazy(() => import("@/pages/settings/RepoCodespacesSettings"));
const RepoPlanningSettings = lazy(() => import("@/pages/settings/RepoPlanningSettings"));
...
const UserProfilePage = lazy(() =>
  import("@/pages/profile/ProfilePage").then((m) => ({ default: m.UserProfilePage })),
);
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "stargazers", element: <StargazersPage /> },
          ...
          { path: "actions/metrics/usage", element: <ActionsUsagePage /> },
          { path: "actions/runs/:runId", element: <RunDetailPage /> },
          { path: "actions/runs/:runId/job/:jobId", element: <JobDetailPage /> },
          { path: "releases", element: <ReleasesPage /> },
          { path: "releases/new", element: <ReleaseEditPage /> },
          { path: "releases/edit/:tag", element: <ReleaseEditPage /> },
          ...
          { path: "security/dependabot", element: <DependabotAlertsPage /> },
          { path: "security/code-scanning", element: <CodeScanningAlertsPage /> },
          { path: "security/secret-scanning", element: <SecretScanningAlertsPage /> },
          { path: "pulse", element: <InsightsPage /> },
          { path: "graphs/traffic", element: <TrafficPage /> },
          { path: "graphs/contributors", element: <ContributorsPage /> },
          { path: "graphs/commit-activity", element: <CommitActivityPage /> },
          { path: "graphs/code-frequency", element: <CodeFrequencyPage /> },
          { path: "community", element: <CommunityPage /> },
          { path: "projects", element: <ProjectsPage /> },
          { path: "projects/:number", element: <ProjectDetailPage /> },
          /* 仓库设置（官方 github.com/:owner/:repo/settings 同路径；D 型左导航 + 子路由） */
          {
            path: "settings",
            element: <RepoSettingsLayout />,
            children: [
              { index: true, element: <Navigate to="general" replace /> },
              { path: "general", element: <RepoSettingsPage /> },
              { path: "collaborators", element: <RepoCollaboratorsSettings /> },
              { path: "moderation", element: <RepoModerationSettings /> },
              { path: "branches", element: <RepoBranchesSettings /> },
              { path: "environments", element: <RepoEnvironmentsSettings /> },
              { path: "webhooks", element: <RepoWebhooksSettings /> },
              { path: "pages", element: <RepoPagesSettings /> },
              { path: "keys", element: <RepoDeployKeysSettings /> },
              { path: "secrets", element: <RepoSecretsSettings /> },
              { path: "security", element: <RepoSecuritySettings /> },
              { path: "installations", element: <RepoGitHubAppsSettings /> },
              { path: "copilot", element: <RepoCopilotSettings /> },
              { path: "codespaces", element: <RepoCodespacesSettings /> },
              { path: "planning", element: <RepoPlanningSettings /> },
            ],
          },
        ],
      },
